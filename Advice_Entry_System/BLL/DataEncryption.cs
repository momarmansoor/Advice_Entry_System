...

{
    public class DataEncryption
    {
        ...
        public static String Encrypt(String plainText) 
        {
            ...
            String passPhrase = "C@llPas5Centerpr@seWebApp";
            String saltValue = "C@lls@1tCenterV@lueMyWeb$ter";
            String hashAlgorithm = "SHA1";
            int passwordIterations = 2;
            String initVector = "@1B2c3D4e5F6g7H8"; 
            int keySize = 256;

        //' Convert strings into byte arrays. Let us assume that strings only contain ASCII codes.
